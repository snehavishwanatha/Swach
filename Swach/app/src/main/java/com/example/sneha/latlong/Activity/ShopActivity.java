...
public class ShopActivity  extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
            ...
            mDataRef.child("LATLONG").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for(latlongdetails y: ll)
                    {
                        ...
                        MarkerOptions marker = new MarkerOptions().position(new LatLng(y.lat,y.longi)).title("Dustbin");
